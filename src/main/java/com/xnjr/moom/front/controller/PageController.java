...
public class PageController {
    ...
    public String indexAction(@PathVariable String module, HttpServletRequest request) {
    ...
    public String commonPage2Action(@PathVariable String first,
            @PathVariable String second, @PathVariable String page, HttpServletRequest request) {
    	String url = (JudgeIsMoblie(request) ? "m/" : "") + first + "/" + second + "/" + page;
    	System.out.println("url: " + url);
        return url;
    }
}
