...
import com.xnjr.moom.front.req.XN805155Req;
...
import com.xnjr.moom.front.req.XN805154Req;
...
public class UserAOImpl implements IUserAO {
	...
	public XN805043Res doLogin(String loginName, String loginPwd, String kind) {
		...
		XN805155Req req = new XN805155Req();
		req.setLoginName(loginName);
		req.setLoginPwd(loginPwd);
		req.setKind("f1");

		return BizConnecter.getBizData("805155", JsonUtils.object2Json(req),
				XN805043Res.class);
	}
