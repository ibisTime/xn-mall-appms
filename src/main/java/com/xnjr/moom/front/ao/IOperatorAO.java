...
public interface IOperatorAO {
	 ...
	 * @return
	 */
	public Object submitCart(String applyUser, List<String> cartCodeList, String addressCode,
	 ...
	 * @return
	 */
	public Object queryPageCommodity(String userId, String code, String modelCode,
			String logisticsCode, String start, String limit, String orderColumn, String orderDir);
	 ...
	 * @return
	 */
	public Object submitRepairOrder(String userId, String goodsCode, String applyUser,
			String contact, String applyReason);
	 ...
	 * @return
	 */
	public Object queryPageRepairOrder(String userId, String code, String goodsCode,String applyUser,
			String status, String updater, String start, String limit, String orderColumn, String orderDir);
}
