        ...
        Ajax.post("805151", {
            ...
            if (res.success) {
            	if(res.data.userId==null ||res.data.userId=="" ){
            		...
            		if(returnFistUrl){
            			if(sessionStorage.getItem("flagHb")==1){//定向红包
            				location.href = "../shake/share-receive.html?code="+sessionStorage.getItem("hbCode")+"&userReferee="+userReferee;
            			}else if(sessionStorage.getItem("flagHb")==2){//摇一摇
            				location.href = "../index.html?userReferee="+userReferee;
            			}else{
