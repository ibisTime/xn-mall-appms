                    ...
                    .then(function (res) {
                        if(res.success){
                            ...
                            $.each(lists,function (i,val) {
		                        ...
		                        if(price2 && price3){
		                        	html2 += '<span class="s_12 t_red">' + price2
	                                + '</span>+<span class="s_12 t_red">' + price3 + '</span>';
		                        }else if(price2 && !price3){
		                        	html2 += '<span class="s_12 t_red">' + price2
	                                + '</span>';
		                        }else if(!price2 && price3){
		                        	html2 += '<span class="s_12 t_red">' + price3 + '</span>';
		                        }
		                        
	                            html2 += '</p><p class="s_10">市场参考价：<span>' + originalPrice + '</span>元</p></div></a></li>';
                            })
